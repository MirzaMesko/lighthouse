...
// /**
//  * Return a union of S and (if S is a kebab-style string) the camelCase version of S.
//  */
// type KeyPair<S> = S | KebabToCamelCase<S>;
...
//      */
//     argv: { [key in keyof Arguments<T>]: Arguments<T>[key] } & { [key in keyof CamelArguments<T>]: CamelArguments<T>[key] };
...
//   type CamelArguments<T = unknown> = {
//     [K in keyof T as KeyPair<K>]: T[K];
//   } & {
//     /** All remaining options */
