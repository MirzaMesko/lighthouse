...
/**
 * @fileoverview Ensures every ARIA meter node has an accessible name
...
const UIStrings = {
  ...
  title: 'ARIA meter nodes have an accessible name',
  ...
  failureTitle: 'ARIA meter nodes do not have an accessible name.',
