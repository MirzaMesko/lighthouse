...
/**
 * @fileoverview Ensures every ARIA progress bar node has an accessible name
...
const UIStrings = {
  ...
  title: 'ARIA progress bar nodes have an accessible name',
  ...
  failureTitle: 'ARIA progress bar nodes do not have an accessible name.',
